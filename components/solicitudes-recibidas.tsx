...
export function SolicitudesRecibidas() {
  ...
  const { getSolicitudesByMentor, updateSolicitud, acceptSolicitud } = useMentorshipData()
  ...
  const solicitudes = getSolicitudesByMentor(userId)

  const handleAcceptSolicitud = () => {
    if (!selectedSolicitud || !fechaSesion) return

    acceptSolicitud(selectedSolicitud, fechaSesion)
  ...
  const handleRejectSolicitud = (id: string) => {
    updateSolicitud(id, { estado: "rechazada" })
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-lg">{solicitud.nombreSolicitante}</CardTitle>
                      <CardDescription>
                        Solicitud enviada el {new Date(solicitud.fecha).toLocaleDateString("es-ES")}
                      </CardDescription>
                    </div>
                  </div>
                    ...
                    <Dialog open={isAcceptDialogOpen} onOpenChange={setIsAcceptDialogOpen}>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Selecciona la fecha y hora para la sesión con {solicitud.nombreSolicitante}
                          </DialogDescription>
                        </DialogHeader>
