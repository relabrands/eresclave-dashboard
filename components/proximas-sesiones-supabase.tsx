...
import type { SesionWithProfiles } from "@/lib/supabase"

interface ProximasSesionesSupabaseProps {
  sesiones: SesionWithProfiles[]
}

export function ProximasSesionesSupabase({ sesiones }: ProximasSesionesSupabaseProps) {
